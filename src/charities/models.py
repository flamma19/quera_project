...
class TaskManager(models.Manager):
    ...
    # for relating tasks -> charities -> if user is charity
    ...
    # for relating tasks -> benefactors -> if user is benefactor
    ...
    # for relating tasks -> all tasks from benefactor section and charity section of user
...
# filtering tasks about users
    ...
    # define a function for assigning tasks to benefactors -> for more, look inside views
    def assign_to_benefactor(self, benefactor):
        self.state = Task.TaskStatus.WAITING
        self.assigned_benefactor = benefactor
        self.save()

    # define a function for responsing to benefactor -> for more, look inside views
    ...
    # define a function for setting done from charity owners -> for more, look inside views
    def done(self):
